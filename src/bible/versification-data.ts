 ...
 *
 * The union of every bundled translation (bsb, kjv, web), rebuilt on
 * 2026-08-26.
 *
...
export const VERSIFICATION_SOURCE = 'bsb + kjv + web';

/** Total verses in the canon under this versification. */
export const VERSIFICATION_TOTAL = 31105;
...
export const LAST_VERSE: readonly (readonly number[])[] = [
  ...
  [
    ...
    20, 23, 19, 9, 6, 7, 23, 13, 11, 11, 17, 12, 8, 12, 11, 10, 13, 20, 7, 35, 36, 5, 24,
    20, 28, 23, 10, 12, 20, 72, 13, 19, 16, 8, 18, 12, 13, 17, 7, 18, 52, 17, 16, 15, 5, 23,
    11, 13, 12, 9, 9, 5, 8, 28, 22, 35, 45, 48, 43, 13, 31, 7, 10, 10, 9, 8, 18, 19, 2, 29,
    176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 13, 10, 7, 12, 15,
    21, 10, 20, 14, 9, 6
  ],
  ...
  // 63 2 John — 1 chapters
  [
    13
  ],
  // 64 3 John — 1 chapters
  [
    14
  ],
  // 65 Jude — 1 chapters
